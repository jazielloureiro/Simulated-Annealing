...
def objective(instance, state):
    ...
    for i in range(instance.queens_amount):
        ...
        conflicts += secondary_diagonal_positions[
            instance.queens_amount - 1 - i + state[i]
        ]
...
def simulated_annealing(instance):
    ...
    while temperature != old_temperature:
        for _ in range(100):
            ...
            objective_difference = objective(instance, neighbour_state) - objective(
                instance, iteration_state
            )
